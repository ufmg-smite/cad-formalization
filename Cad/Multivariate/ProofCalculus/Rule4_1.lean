...
theorem nalbach_4_1
  ...
  have deg_inv := brown_original i f hp_i0 discr_ne_zero S h_sub h_conn h_ord_inv h_ord_lc_inv h_non_null
...
theorem nalbach_4_1_generalized
  ...
  intros h_sub h_conn h_non_null h_ord_inv h_ord_lc_inv
  have h_deg_inv :=
    brown_generalized i f P hP hP_mem₁ hf_deg S h_sub h_conn h_ord_inv h_ord_lc_inv h_non_null
